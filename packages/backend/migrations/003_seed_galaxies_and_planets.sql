...
INSERT INTO galaxy_templates (id, name, description, coordinates) VALUES
	('galaxy-milky-way', 'Milky Way', 'The home galaxy of Earth.', '{"x":0,"y":0}'),
	('galaxy-jades', 'JADES-GS-z14-0', 'A distant galaxy.', '{"x":1000,"y":0}');

-- Seed star system templates
INSERT INTO star_system_templates (id, name, galaxy_template_id, description, coordinates) VALUES
	('system-sol', 'Sol System', 'galaxy-milky-way', 'The home system of Earth.', '{"x":0,"y":0}'),
	('system-icarus', 'Icarus System', 'galaxy-milky-way', 'Remote system with Icarus planet.', '{"x":100,"y":200}'),
	('system-destiny', 'Destiny System', 'galaxy-jades', 'System where Destiny is found.', '{"x":500,"y":500}');
