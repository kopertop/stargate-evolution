...
INSERT INTO room_templates (id, layout_id, type, name, description, start_x, start_y, end_x, end_y, floor, found, connection_north, connection_south, connection_east, connection_west, base_exploration_time, locked) VALUES
	-- Gate Room/Storage Room (large central room with stargate)
	('gate_room', 'destiny', 'gate_room', 'Gate Room', 'Main Stargate room with storage', -2, -2, 2, 2, 0, true, 'south_corridor', NULL, 'control_interface', 'north_corridor', 2, false),

	-- Corridors around the gate room
	('north_corridor', 'destiny', 'corridor_basic', 'North Corridor', 'Corridor west of gate room', -4, -1, -2, 1, 0, false, NULL, NULL, 'gate_room', NULL, 0, false),
	('south_corridor', 'destiny', 'corridor_basic', 'South Corridor', 'Corridor north of gate room', -1, 2, 1, 4, 0, false, NULL, 'gate_room', NULL, NULL, 0, false),

	-- Control Interface and Kino Room (to the right of gate room)
	('control_interface', 'destiny', 'control_room', 'Control Interface', 'Ship control systems', 2, -1, 4, 1, 0, false, NULL, NULL, 'kino_room', 'gate_room', 4, false),
	('kino_room', 'destiny', 'kino_room', 'Kino Room', 'Kino storage and control', 4, -1, 6, 1, 0, false, NULL, NULL, NULL, 'control_interface', 2, false),

	-- Additional rooms for future expansion (simplified for now)
	('bridge', 'destiny', 'bridge_command', 'Bridge', 'Command center', -1, 4, 1, 6, 0, false, NULL, 'south_corridor', NULL, NULL, 48, true),
	('medical_bay', 'destiny', 'medical_bay_standard', 'Medical Bay', 'Medical bay', 6, -1, 8, 1, 0, false, NULL, NULL, NULL, 'kino_room', 4, false),
	('mess_hall', 'destiny', 'mess_hall_standard', 'Mess Hall', 'Mess hall', -6, -1, -4, 1, 0, false, NULL, 'north_corridor', NULL, NULL, 2, false),

	-- Multi-level rooms (for future expansion)
	('engineering', 'destiny', 'engineering_main', 'Engineering', 'Engineering section', -2, -2, 2, 2, 1, false, NULL, NULL, NULL, NULL, 12, false),
	('hydroponics', 'destiny', 'hydroponics_bay', 'Hydroponics', 'Hydroponics bay', -2, -2, 2, 2, -1, false, NULL, NULL, NULL, NULL, 6, false);
