...
INSERT INTO room_templates (id, layout_id, type, name, description, start_x, start_y, end_x, end_y, floor, initial_state, connection_north, connection_south, connection_east, connection_west) VALUES
	...
	('south_corridor', 'destiny', 'corridor_basic', 'South Corridor', 'Corridor north of gate room', -1, 2, 1, 4, 0, '{"found":false,"locked":false,"explored":false}', NULL, 'gate_room', NULL, NULL),

	-- Control Interface and Kino Room (to the right of gate room)
	('control_interface', 'destiny', 'control_room', 'Control Interface', 'Ship control systems', 2, -1, 4, 1, 0, '{"found":false,"locked":false,"explored":false}', NULL, NULL, 'kino_room', 'gate_room'),
	('kino_room', 'destiny', 'kino_room', 'Kino Room', 'Kino storage and control', 4, -1, 6, 1, 0, '{"found":false,"locked":false,"explored":false}', NULL, NULL, NULL, 'control_interface'),

	-- Additional rooms for future expansion (simplified for now)
	('bridge', 'destiny', 'bridge_command', 'Bridge', 'Command center', -1, 4, 1, 6, 0, '{"found":false,"locked":true,"explored":false}', NULL, 'south_corridor', NULL, NULL),
	('medical_bay', 'destiny', 'medical_bay_standard', 'Medical Bay', 'Medical bay', 6, -1, 8, 1, 0, '{"found":false,"locked":true,"explored":false}', NULL, NULL, NULL, 'kino_room'),
	('mess_hall', 'destiny', 'mess_hall_standard', 'Mess Hall', 'Mess hall', -6, -1, -4, 1, 0, '{"found":false,"locked":false,"explored":false}', NULL, NULL, 'north_corridor', NULL),

	-- Multi-level rooms (for future expansion)
	('engineering', 'destiny', 'engineering_main', 'Engineering', 'Engineering section', -2, -2, 2, 2, 1, '{"found":false,"locked":false,"explored":false}', NULL, NULL, NULL, NULL),
	('hydroponics', 'destiny', 'hydroponics_bay', 'Hydroponics', 'Hydroponics bay', -2, -2, 2, 2, -1, '{"found":false,"locked":true,"explored":false}', NULL, NULL, NULL, NULL);
