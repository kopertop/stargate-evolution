...
import { Modal, Container, Row, Col, Card, ProgressBar, Badge, Table, Nav } from 'react-bootstrap';
import { 
  FaBolt, 
  FaShieldAlt, 
  FaHeart, 
  ...
  const renderExplorationTab = () => (
    <div>
      <div className="d-flex align-items-center mb-3">
        ...
        <h5 style={{ color: 'white', margin: 0 }}>Explored Areas: {exploredRooms.length}</h5>
      </div>
